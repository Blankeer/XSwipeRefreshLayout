...
public class NeuSwipeRefreshLayout extends ViewGroup {
    // Maps to ProgressBar.Large style
    public static final int LARGE = NeuMaterialProgressDrawable.LARGE;
    // Maps to ProgressBar default style
    public static final int DEFAULT = NeuMaterialProgressDrawable.DEFAULT;
    private static final float MAX_SWIPE_DISTANCE_FACTOR = .6f;
    private static final int REFRESH_TRIGGER_DISTANCE = 120;
    private static final String LOG_TAG = NeuSwipeRefreshLayout.class.getSimpleName();
    ...
    private NeuSwipeRefreshLayoutDirection mDirection;
    ...
    private NeuCircleImageView mCircleView;
    ...
    private NeuMaterialProgressDrawable mProgress;
    ...
    private void startRefresh() {
        ...
        setRefreshing(true);
        mNotify = true;//必须放在setRefreshing后面，因为set方法会清空这个标志位
    }
    ...
    public NeuSwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        NeuSwipeRefreshLayoutDirection direction
                = NeuSwipeRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.NeuSwipeRefreshLayout_direction, 0));
    ...
    public void setSize(int size) {
        if (size != NeuMaterialProgressDrawable.LARGE && size != NeuMaterialProgressDrawable.DEFAULT) {
            return;
        }
        final DisplayMetrics metrics = getResources().getDisplayMetrics();
        if (size == NeuMaterialProgressDrawable.LARGE) {
    ...
    private void createProgressView() {
        mCircleView = new NeuCircleImageView(getContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new NeuMaterialProgressDrawable(getContext(), this);
     ...
     */
    public void setProgressBackgroundResources(int colorRes) {
        mCircleView.setBackgroundColorResources(colorRes);
...
//        }
    ...
    public NeuSwipeRefreshLayoutDirection getDirection() {
        return mBothDirection ? NeuSwipeRefreshLayoutDirection.BOTH : mDirection;
    }

    public void setDirection(NeuSwipeRefreshLayoutDirection direction) {
        if (direction == NeuSwipeRefreshLayoutDirection.BOTH) {
            mBothDirection = true;
        } else {
            mBothDirection = false;
    ...
    // only TOP or Bottom
    private void setRawDirection(NeuSwipeRefreshLayoutDirection direction) {
